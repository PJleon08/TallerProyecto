...
class Professor(Persona):
    def __init__(self, id, personId, name, age, gender, path, salary, especiality, professional_lvl):
        Persona.__init__(self, id, personId, name, age, gender, path)
        self.Salary = salary
        self.Especiality = especiality
        self.Profession_lvl = professional_lvl

class Estudiante(Persona):
    def __init__(self, id, personId, name, age, gender, path, carne, career, lastName):
        Persona.__init__(self, id, personId, name, age, gender, path)
        self.Carne = carne
        self.Career = career
...
class Administrativo(Persona):
    def __init__(self, id, personId, name, age, gender, path, sector, officeExtension, officeNumber):
        Persona.__init__(self, id, personId, name, age, gender, path)
        self.Sector = sector
...
def printMenuEstudiante():
    ...
    try:
        while exitOption == False:
            ...
            group_id = int(IDstr)
            person_Id = create_person(name, "Estudiante", picture, group_id)
            analysis = emotions(picture)
            age = analysis[0]['faceAttributes']['age']
            gender = analysis[0]['faceAttributes']['gender']
            newEstudiante = Estudiante(group_id, person_Id, name, age, gender, picture, carne, career, lastName)
        ...
        print("Ha digite un valor inválido!")
...
def printMenuProfessor():
    ...
    try:
        while exitOption == False:
            ...
            group_id = int(IDstr)
            person_Id = create_person(name, "Profesor", picture, group_id)
            analysis = emotions(picture)
            age = analysis[0]['faceAttributes']['age']
            gender = analysis[0]['faceAttributes']['gender']
            newProfessor = Professor(group_id, person_Id, name, age, gender, picture, salary, especility, professional_lvl)
...
def printMenuAdministrador():
    ...
    try:
        while exitOption == False:
            ...
            age = analysis[0]['faceAttributes']['age']
            gender = analysis[0]['faceAttributes']['gender']
            newAuxiliar = Administrativo(group_id, person_Id, name, age, gender, picture, sector, officeExtension, officeNumber)
