...
def printMenuAdministrador():
    ...
    while exitOption == False:
        ...
        age = analysis[0]['faceAttributes']['age']
        gender = analysis[0]['faceAttributes']['gender']
        newAdmin = Administrativo(group_id, person_Id, name, age, gender, picture, "Admistrativo", sector , officeNumber , officeExtension )
        with open("personas.bin", "ab") as f:  
...
def OrderedAchive():
    lista = read_file()
    listaOrdenada = insertionOrder(lista)
...
if __name__ == "__main__":
    ...
    #read_file()
    #with open("personas.bin", "ab") as f:
        #persona9 = Persona( 666, 87282828, "Nallely", "102", "Male", "C/jdjdj","Actor")

        #pickle.dump(persona9, f , pickle.HIGHEST_PROTOCOL)
    OrderedAchive()
    #lista = read_file()
    #for x in lista:
        #print (x)

#with open("personas.bin","rb") as f:
#        e = pickle.load(f)
#        print(e.iden, e.name, e.person_id, e.profession)
#        e = pickle.load(f)
#        print(e.iden, e.name, e.person_id, e.profession)
#    read_file()
